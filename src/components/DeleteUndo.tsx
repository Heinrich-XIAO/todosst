...
export function UndoToast({
  ...
  return (
      <div className="fixed bottom-20 left-1/2 z-40 flex -translate-x-1/2 items-center gap-3 border border-foreground bg-background px-4 py-2 text-xs shadow-sm md:bottom-4">
      <span>
